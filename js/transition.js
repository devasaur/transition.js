...
var PageTransitions = (function () {
    ...
    function Animate($pageTrigger) {
        ...
        if(animation.indexOf('-') != -1) {
            ...
            var selectedFloatNumber = parseFloat(selectedAnimNumber); 

		
			
					if ($("#usedNum:contains("+selectedFloatNumber+")").length !=  0){
						   if(usedNumList == randomAnimList.length){
					       $("#usedNum").html("");
				           usedNumList = 0;
						   Animate($pageTrigger);
						   return false;
						...
						$("<i>-"+selectedFloatNumber+"<i>").appendTo("#usedNum");
						usedNumList = usedNumList + 1;
						}
